...
/*
Problem here -> we want to create NewRectangle -> and DrawPoints from this rectangle
But we can not DrawPoints from NewRectangle
Solution:
*/
...
func (a *vectorToRasterAdapter) addLineHash(line Line) {
	hash := func(object interface{}) [16]byte {
